...
namespace appInvictusStyle.Layers.Reportes
{
    public partial class FrmReporteArticulos : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'ReporteCliente.Articulo' table. You can move, or remove it, as needed.
            this.ArticuloTableAdapter.Fill(this.ReporteCliente.Articulo);
